...
function HBC30Construct(det::HBC30)::CxxPtr{G4VPhysicalVolume}
    ...
    chamberS  = G4Tubs("chamber", 0, chamberDiameter/2, 10cm, 0, 2π)
    ...
    boxVisAtt = G4VisAttributes(G4Colour(1.0, 1.0, 1.0, 0.05))
    targetVisAtt = G4VisAttributes(G4Colour(0.0, 0.0, 1.0, 0.8))
    chamberVisAtt = G4VisAttributes(G4Colour(1.0, 1.0, 0.0, 0.2))
